...
class baseOpt:
	...
	def initialize(self, parser):
		...
		parser.add_argument('--model', default='advModel', help='model: advModel and VGG_ED.')
		...
		parser.add_argument('--sample_dir', type=str, default=None, help='sample dir to eval through the model')
